...
export function LinkTapIcon({ className }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
      <path d="M8 12a4 4 0 0 1 4-4h1" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
      <path d="M16 12a4 4 0 0 1-4 4h-1" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
      <circle cx="12" cy="12" r="9" stroke="currentColor" strokeWidth="2" />
    </svg>
  )
}
...
export function ChatIcon({ className }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
      <path
        d="M12 3a9 9 0 0 0-7.8 13.4L3 21l4.8-1.2A9 9 0 1 0 12 3Z"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function EyeOffIcon({ className }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
      <path
        d="M3 3l18 18M10.6 5.2A9.9 9.9 0 0 1 12 5c6 0 9.5 7 9.5 7a15.5 15.5 0 0 1-3.2 4.2M6.6 6.6C4 8.3 2.5 12 2.5 12s3.5 7 9.5 7a9.3 9.3 0 0 0 3.9-.8"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M9.9 10.1a2.5 2.5 0 0 0 3.6 3.5"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function LockIcon({ className }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
      ...
      <path d="M8 11V8a4 4 0 0 1 8 0v3" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
...
export function GlobeIcon({ className }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
      <circle cx="12" cy="12" r="9" stroke="currentColor" strokeWidth="2" />
      <path d="M3 12h18M12 3c2.5 2.5 3.8 5.7 3.8 9s-1.3 6.5-3.8 9c-2.5-2.5-3.8-5.7-3.8-9S9.5 5.5 12 3Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}
...
export function DocumentIcon({ className }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
      <path d="M6 3h9l4 4v14a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M9 12h7M9 16h7M9 8h3" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    </svg>
  )
}
...
export function MailIcon({ className }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
      ...
      <path d="M3.5 6.5 12 13l8.5-6.5" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}
...
export function FingerprintIcon({ className }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
      <path d="M12 4a8 8 0 0 1 8 8v2" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
      <path d="M4 14v-2a8 8 0 0 1 12.5-6.6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
      <path d="M8 20.5A6 6 0 0 0 12 22a6 6 0 0 0 4-10.5" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
      <path d="M8 12a4 4 0 0 1 7-2.6M9.5 17a4 4 0 0 0 5.6-2" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
      <path d="M12 12v2.5" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    </svg>
  )
}
...
export function DeviceIcon({ className }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
      ...
      <path d="M6 19h6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
      <rect x="16.5" y="9" width="6" height="10" rx="1.5" stroke="currentColor" strokeWidth="2" />
      <path d="M18.7 16.5h1.6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    </svg>
  )
}
...
export function SnowflakeIcon({ className }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
      <path
        d="M12 2v20M4 7l16 10M20 7 4 17M7 4l5 3.5L17 4M7 20l5-3.5L17 20M2.5 12h19"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function KeyIcon({ className }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
      ...
      <path d="M11 12 20 3M16 8l3 3M19 5l2.5 2.5" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}
...
// --- Wallet-hub icons (added for the Alipay-style flows) ---
...
export function QrIcon({ className }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
      ...
      <path d="M14 14h3v3M20 14v6M14 20h3" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}
...
export function WalletIcon({ className }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
      <path d="M4 7a2 2 0 0 1 2-2h11a1 1 0 0 1 1 1v2" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
...
export function ReceiptIcon({ className }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
      <path d="M6 3h12v18l-3-1.8L12 21l-3-1.8L6 21V3Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
...
export function ShareIcon({ className }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
      ...
      <path d="m8.2 10.8 7.6-4.6M8.2 13.2l7.6 4.6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    </svg>
  )
}
...
export function CopyIcon({ className }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
      ...
      <path d="M15 5H5a2 2 0 0 0-2 2v10" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}
...
export function SignalIcon({ className }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
      <path d="M5 15v4M10 11v8M15 7v12M20 3v16" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    </svg>
  )
}
